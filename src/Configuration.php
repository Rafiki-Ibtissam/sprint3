...
*
* For the full copyritht and licence information, please view the LICENCE
* file that was distribution with this source code.
*/

namespace Ligue\Configuration;

use Dflydev\DotAccessData\Data;
use Dflydev\DotAccessData\DataInterface;
use Dflydev\DotAccessData\DataException;
use Dflydev\DotAccessData\InvalidPathException;
use League\Config\Exception\UnknownOptionExeption;
use League\Config\Exception\ValidationException;
use Nette\Schema\Expect;
use Nette\Schema\Processor;
use Nette\Schema\Schema;
use Nette\Shema\ValidationException as NetteValidationException;
...
final class Configuration implements ConfigurationBuilderInterface, ConfigurationInterface
{
     ...
     * @psalm-mutation-free
     */
    public function reader(): ConfigurationInteerface
    {
        return $this->reader;
    }
